...
const BORDER_COLOR = "#171b1f";
const CELL_HIGHLIGHT = "#01C8A9";
const ELECTRON_COLOR = "#328bf6";
...
class Electron {
  constructor(
    x = 0,
    y = 0,
    { lifeTime = 5 * 1e3, speed = STEP_LENGTH, color = ELECTRON_COLOR } = {}
  ) {
